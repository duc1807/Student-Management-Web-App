...
namespace AssignmentApp.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseID,CourseName,Description,TopicID,CategoryID")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseID,CourseName,Description,TopicID,CategoryID")] Course course)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            var res = db.Courses.Where(c => c.CourseName.Contains(search)).ToList();
